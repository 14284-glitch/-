...
def main() -> None:
    ...
    page = st.sidebar.radio(
        "功能選單",
        ("市場總覽", "個股分析", "財經新聞", "模型預測", "策略回測", "系統狀態"),
        help="切換市場行情、個股技術分析、財經新聞、模型預測、策略回測或系統更新狀態。",
    )
    renderers = {
        "市場總覽": market_overview.render, "個股分析": stock_analysis.render,
        "財經新聞": financial_news.render,
    ...
    sidebar_descriptions = {
        ...
        "財經新聞": "瀏覽台股、國際市場與科技產業新聞，可依分類或關鍵字篩選。",
    ...
    st.sidebar.caption("介面版本：2026.07.18-16")
